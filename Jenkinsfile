    ...
    stages {
        ...
        stage('Build Docker Image') {
            ...
            steps {
                ...
                script {
                    app = docker.build("rdarst/petclinic-spinnaker-jenkins")
                }
            }
        }
        ...
        stage('Remove local images') {
            steps {
                ...
                sh("docker rmi -f rdarst/petclinic-spinnaker-jenkins:latest || :")
                sh("docker rmi -f rdarst/petclinic-spinnaker-jenkins:$SHORT_COMMIT || :")
            }
        }
    }
}
